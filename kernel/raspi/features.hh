...
public:
        ...
        constexpr inline bool stage1_tgran4() noexcept { return ((mmfr0 >> 28) & 0xe) == 0; }
        constexpr inline bool stage1_tgran16() noexcept {
                uint32_t i = (mmfr0 >> 20) & 0xf;
                return i == 1 || i == 2;
        }
        constexpr inline bool stage1_tgran64() noexcept { return ((mmfr0 >> 24) & 0xf) == 0; }
        ...
        constexpr inline bool mixed_endian() noexcept { return ((mmfr0 >> 8) & 0xf) == 1; }
        constexpr inline bool sns_mem() noexcept { return ((mmfr0 >> 12) & 0xf) == 1; }
        constexpr inline bool mixed_endian_el0() noexcept { return mixed_endian() || ((mmfr0 >> 16) & 0xf) == 1; }
